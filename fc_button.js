...
function FCMenu() {
  Game.UpdateMenu = function() {
    if (Game.onMenu !== 'fc_menu') {
      ...
      var bankFrenzyLucky = {'cost': frenzyLuckyBank(), 'efficiency': cookieEfficiency(Game.cookies, frenzyLuckyBank())};
      ...
      buildTable.append($('<tr><td><b>Lucky Frenzy Bank</b></td><td>n/a</td><td>' + Beautify(bankFrenzyLucky.efficiency) + '</td><td>' + Beautify(Math.max(0,bankFrenzyLucky.cost - Game.cookies)) + '</td><td>' + Beautify(gcPs(cookieValue(bankFrenzyLucky.cost) - cookieValue(Game.cookies))) + '</td></tr>'));
