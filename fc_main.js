...
function checkPrices(discount) {
  ...
  if (discount > 0 && FrozenCookies.caches.recommendationList.length > 0) {
    ...
    nextRec = nextPrereq == null ? nextRec : FrozenCookies.caches.recommendationList.filter(function(a){return prereqList.some(function(b){return b.id == a.id && b.type == a.type})})[0];
